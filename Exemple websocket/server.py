...
class WebSocket(object) :
    ...
    async def majChat(self,message):
        ...
        await asyncio.wait([client.send(mes) for client in self.Clients]) ## qu'on envoie à nos clients
    ...
    def __init__(self):
        ...
        start_server = websockets.serve(self.ConnexionWebSocket, "81.14.92.212", 1002) ## on lance le serveur, cette fonction prend en parametre :
